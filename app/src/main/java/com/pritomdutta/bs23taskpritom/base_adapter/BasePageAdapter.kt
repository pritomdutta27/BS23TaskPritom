...
abstract class BasePageAdapter<T : Any>(
    ...
    override fun areItemsTheSame(oldItem: T, newItem: T)= contentsSame(oldItem, newItem)
    override fun areContentsTheSame(oldItem: T, newItem: T) = itemsSame(oldItem, newItem)
}) {
